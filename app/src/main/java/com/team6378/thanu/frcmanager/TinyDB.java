...
public class TinyDB {
    ...
    public ArrayList<Tournament> getListObject(String key, Class<?> mClass){
    	Gson gson = new Gson();

    	ArrayList<String> objStrings = getListString(key);
    	ArrayList<Tournament> objects =  new ArrayList<Tournament>();

    	for(String jObjString : objStrings){
    		Tournament value  = (Tournament) gson.fromJson(jObjString,  mClass);
    		objects.add(value);
    	}
    	return objects;
    }
    ...
    public void putListObject(String key, ArrayList<Tournament> objArray){
    	checkForNullKey(key);
    	Gson gson = new Gson();
